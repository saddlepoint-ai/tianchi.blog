...
description: "用 dot-com 泡沫的机制复盘，拆解 2026 年 AI 的真实价值、估值风险、基础设施过度建设和可能的转折信号。"
pubDate: 2026-06-13
...
这篇文章要回答的不是“AI 有没有用”，而是一个更窄的问题：**AI 已经创造真实价值之后，当前模型公司、算力公司和应用公司的价格，是否过早买进了未来很多年的采用率和利润率。**

本文结论是：AI 这一波不是“没有真实价值”的泡沫。OpenAI、Anthropic 已经有非常罕见的收入规模，NVIDIA 更是有可审计的巨额利润。但它也明显有泡沫结构：估值基于 run-rate 而非完整 S-1/10-K，收入质量、毛利、留存、关联方收入和长期算力承诺仍不透明，基础设施投入强度很像 1990s 末的 telecom overbuild。

更准确的说法是：**AI 像 dot-com + telecom 的混合体。应用层已经有真实 ARR，基础设施层已经有真实利润；风险在于价格和资本开支把“未来的全部采用率”提前资本化了。**
...
“泡沫”在这里不是骂人，也不是说技术没有用。更有用的定义是：**真实技术趋势被资本市场用过高价格、过长久期、过乐观利润率提前买满。**

所以本文不问一个大而化之的问题，而是按四个问题判断：

| 问题 | 如果答案是“是” | 如果答案是“否” |
|---|---|---|
| 需求是真的吗 | 有用户、收入和使用习惯 | 更接近 1999 年 eyeballs-only |
| 收入质量清楚吗 | 可以看 GAAP revenue、gross/net、留存、回款 | run-rate 可能被 credits、一次性部署、关联方交易扭曲 |
| 经营杠杆成立吗 | 收入增长快于推理成本、销售成本和研发成本 | usage 越大亏损越大，像补贴型基础设施消耗 |
| 资本开支能被现金流覆盖吗 | 算力投入由稳定需求支撑 | 长期 GPU/电力/机房合同把未来需求提前押注 |

这也是为什么“AI 有用”和“AI 有泡沫”可以同时成立。本文的因果链是：

| 步骤 | 要说明什么 |
|---|---|
| 先看 dot-com | 真技术如何被资本机制推成坏价格 |
| 再看 2026 AI | OpenAI、Anthropic、中国基模公司、NVIDIA 分别站在哪一层 |
| 再比较两派观点 | 泡沫论和真实价值论分别抓住哪些事实 |
| 最后给观察框架 | 哪些模式危险、哪些模式更抗泡沫、什么信号可能触发重估 |

## 第一部分：Dot-com 泡沫怎样从真技术变成坏价格
...
## 第二部分：把 2026 AI 拆成四层看

AI 不是一个统一资产。至少要拆成四层：frontier model 公司、应用层公司、AI cloud / data center、芯片和硬件供应商。同一个泡沫周期里，不同层的收入质量和风险完全不同。

| 层 | 代表 | 关键问题 |
|---|---|---|
| Frontier model | OpenAI、Anthropic、xAI、Zhipu、Moonshot、MiniMax | 收入是否高毛利、可留存，是否足以覆盖训练和推理成本 |
| 应用层 | coding agent、客服、办公、垂直 workflow | 是否拥有 workflow 和分发，而不是薄薄包一层模型 |
| AI cloud / data center | GPU 租赁、云厂商、机房、电力 | 长期资产和短期客户需求是否匹配 |
| 芯片/硬件 | NVIDIA、HBM、网络设备 | 利润真实，但是否过度依赖 AI capex 持续上行 |
...
更稳妥的问法不是“哪一天崩”，而是“哪些观察同时出现，说明市场开始重新定价”。可以看五组信号：
...
把两种直觉放在一起看：“大模型公司都是泡沫”和“这一波有真实 ARR 和新价值”并不冲突。
